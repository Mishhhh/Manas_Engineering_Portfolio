...
export default function CommandPalette({ open, onClose }) {
  ...
  const commands = useMemo(
    () => [
      ...
      { id: "go-retry-engine", label: "Retry Engine", hint: "/lab/retry-engine", icon: FlaskConical, run: () => nav("/lab/retry-engine") },
      { id: "go-arrears", label: "Arrears Simulator", hint: "/lab/arrears", icon: FlaskConical, run: () => nav("/lab/arrears") },
      { id: "go-sql-arena", label: "SQL Arena", hint: "/lab/sql-arena", icon: FlaskConical, run: () => nav("/lab/sql-arena") },
